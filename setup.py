...
def clone_and_install(
    ...
    pip_path = osp.join(clone_to, sub_path) if sub_path else clone_to
    if install_mode == "editable":
        subprocess.run(["pip", "install", "-e", pip_path])
    elif install_mode == "normal":
        subprocess.run(["pip", "install", pip_path])
    else:
...
if __name__ == "__main__":
    # Clone and install third-party repositories
    subprocess.run(["git", "submodule", "update", "--init"])

    # Install halpe cocoapi
    halpecocoapi_dir = "vendor/HalpeCOCOAPI/PythonAPI"
    subprocess.run(["pip", "install", "-e", halpecocoapi_dir])
